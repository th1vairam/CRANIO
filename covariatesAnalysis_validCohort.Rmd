...
Gx = Diagnosis + RNA\_days\_to\_Harvest + Diagnosis x RNA\_days\_to\_Harvest + Batch + Sex + Age\_at\_Collection + 
...
DEXP_OBJ = File('CRANIO2_DiffExpression.tsv', name = 'Differential Expression Results (cogdx)', 
                parentId = CODE$properties$id)
