...
knit2synapse::knitToFolderEntity(file = "./covariatesAnalysis_validCohort.Rmd",
                                 parentId = "syn2820780",
                                 entityName = 'Case-control and sub-type differential expression (validation cohort)')
```
...
# Code
CODE <- Folder(name = "Case-control and sub-type differential expression (validation cohorts)", parentId = parentId)
